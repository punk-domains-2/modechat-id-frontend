<template>
  ...
  <td>
    ...
    <span 
      v-else 
      class="text-click"
      data-bs-toggle="modal" :data-bs-target="'#defaultNameModal'+getDomainName"
    >
      Set as default name
    </span>
  </td>
  ...
  <div class="modal fade text-start" :id="'defaultNameModal'+getDomainName" tabindex="-1" :aria-labelledby="'defaultNameModalLabel'+getDomainName" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button :id="'closeDefaultDomainModal'+getDomainName" type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        </div>
      </div>
    </div>
  </div>
